...
<body>
    <div class="sidebar">
        <h4 class="sidebar-brand">Printer</h4>
        <ul>
            <li class="active">
...
if (isset($_GET['id'])) {
   ...
   $queryPrinter = "SELECT * FROM printer_tb WHERE idPrinter = '".$dataTransaksi['Printer_tblIdPrinter']."'";
   ...
   $queryUpdateStok = "UPDATE printer_tb SET stok = '$stokBaru' WHERE idPrinter = '".$dataTransaksi['Printer_tblIdPrinter']."'";
   ...
   $run = mysqli_query($koneksi, $queryUpdateStatus);
    ...
    if ($run) {
        ...
        if ($stokBaru == 0) {
            $queryHapusPrinter = "DELETE FROM printer_tb WHERE idPrinter = '".$dataTransaksi['Printer_tblIdPrinter']."'";
